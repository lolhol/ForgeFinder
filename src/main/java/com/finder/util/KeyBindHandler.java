...
public class KeyBindHandler {
  ...
  public static void holdLeftClick() {
    KeyBinding.setKeyBindState(
      ForgeFinder.MC.gameSettings.keyBindAttack.getKeyCode(),
      true
    );
  }
  ...
  public static void initializeCustomKeybindings() {
    macroKeybinds[0] =
      new KeyBinding("Start/Stop macro", Keyboard.KEY_F, "MightyMiner");
    macroKeybinds[1] = new KeyBinding("Debug", Keyboard.KEY_H, "MightyMiner");
    macroKeybinds[2] =
      new KeyBinding("Open GUI", Keyboard.KEY_RSHIFT, "MightyMiner");
