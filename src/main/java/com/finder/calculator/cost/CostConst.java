package com.finder.calculator.cost;
...
public class CostConst {
  ...
  public static double WALK_ONE_OVER_SOUL_SAND_COST = WALK_ONE_BLOCK_COST * 2; // 0.4 in BlockSoulSand but effectively about half
  public static double LADDER_UP_ONE_COST = 20 / 2.35; // 8.511
  public static double LADDER_DOWN_ONE_COST = 20 / 3.0; // 6.667
  public static double SNEAK_ONE_BLOCK_COST = 20 / 1.3; // 15.385
  public static double SPRINT_ONE_BLOCK_COST = 20 / 5.612; // 3.564
  public static double SPRINT_MULTIPLIER =
    SPRINT_ONE_BLOCK_COST / WALK_ONE_BLOCK_COST; // 0.769
  /**
   * To walk off an edge you need to walk 0.5 to the edge then 0.3 to start falling off
   */
  public static double WALK_OFF_BLOCK_COST = WALK_ONE_BLOCK_COST * 0.8; // 3.706
  /**
   * To walk the rest of the way to be centered on the new block
   */
  public static double CENTER_AFTER_FALL_COST =
    WALK_ONE_BLOCK_COST - WALK_OFF_BLOCK_COST; // 0.927
  ...
  public static double[] FALL_N_BLOCKS_COST = generateFallNBlocksCost();
   ...
   */
  public static double JUMP_ONE_BLOCK_COST =
  ...
  public static double calculateTimeToWalkOneBlock(
